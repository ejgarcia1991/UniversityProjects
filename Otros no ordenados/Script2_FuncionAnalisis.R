...
model.ejercicio41.Resultado<- Analisis(datos,model.ejercicio41)

model.ejercicio42 <- lm(y~poly(x2,3), data = datos)
model.ejercicio42.Resultado <- Analisis(datos,model.ejercicio42)

model.ejercicio43 <- lm(y~poly(x3,3), data = datos)
model.ejercicio43.Resultado <- Analisis(datos,model.ejercicio43)

model.ejercicio44 <- lm(y~poly(x1,3)+poly(x2,3)+poly(x3,3), data = datos)
model.ejercicio44.Resultado <- Analisis(datos,model.ejercicio44)

model.ejercicio45 <- lm(y~poly(x1,3)*poly(x2,3)*poly(x3,3), data = datos)
model.ejercicio45.Resultado <- Analisis(datos,model.ejercicio45)
...
model.ejercicio51.Resultado<- Analisis(datos,model.ejercicio41)

model.ejercicio52 <- lm(y~ns(x2,3), data = datos)
model.ejercicio52.Resultado <- Analisis(datos,model.ejercicio42)

model.ejercicio53 <- lm(y~ns(x3,3), data = datos)
model.ejercicio53.Resultado <- Analisis(datos,model.ejercicio43)

model.ejercicio54 <- lm(y~ns(x1,3)+ns(x2,3)+ns(x3,3), data = datos)
model.ejercicio54.Resultado <- Analisis(datos,model.ejercicio44)

model.ejercicio55 <- lm(y~ns(x1,3)*ns(x2,3)*ns(x3,3), data = datos)
model.ejercicio55.Resultado <- Analisis(datos,model.ejercicio45)
...
model.ejercicio61.Resultado <- Analisis(datos,model.ejercicio61)

model.ejercicio62 <- gam(y~s(x1,4)+s(x2,4)+s(x3,4), data = datos)
model.ejercicio62.Resultado <- Analisis(datos,model.ejercicio62)

model.ejercicio63 <- gam(y~s(x1,16)+s(x2,16)+s(x3,16), data = datos)
model.ejercicio63.Resultado <- Analisis(datos,model.ejercicio63)

model.ejercicio64 <- gam(y~s(x1,16)+s(x2,16)+s(x3,16), data = datos)
model.ejercicio64.Resultado <- Analisis(datos,model.ejercicio64)
...
# Apartado a
model.ejercicio71 <- lm(y~poly(x1,3), data = datos)
model.ejercicio71.Resultado<- Analisis(datos,model.ejercicio71)

model.ejercicio72 <- lm(y~poly(x2,3), data = datos)
model.ejercicio72.Resultado <- Analisis(datos,model.ejercicio72)

model.ejercicio73 <- lm(y~poly(x1,3)+poly(x2,3), data = datos)
model.ejercicio73.Resultado <- Analisis(datos,model.ejercicio73)

model.ejercicio74 <- lm(y~poly(x1,3)*poly(x2,3), data = datos)
model.ejercicio74.Resultado <- Analisis(datos,model.ejercicio74)

df <- data.frame(rbind(model1=model.ejercicio71.Resultado,
                       model2=model.ejercicio72.Resultado,
                       model3=model.ejercicio73.Resultado,
                       model4=model.ejercicio74.Resultado),
                 stringsAsFactors = FALSE)
df
...
model.ejercicio71b <- lm(y~ns(x1,3), data = datos)
model.ejercicio71b.Resultado<- Analisis(datos,model.ejercicio71b)

model.ejercicio72b <- lm(y~ns(x2,3), data = datos)
model.ejercicio72b.Resultado <- Analisis(datos,model.ejercicio72b)

model.ejercicio73b <- lm(y~ns(x1,3)+ns(x2,3), data = datos)
model.ejercicio73b.Resultado <- Analisis(datos,model.ejercicio73b)

model.ejercicio74b <- lm(y~ns(x1,3)*ns(x2,3), data = datos)
model.ejercicio74b.Resultado <- Analisis(datos,model.ejercicio74b)

df2 <- data.frame(rbind(model1=model.ejercicio71b.Resultado,
                       model2=model.ejercicio72b.Resultado,
                       model3=model.ejercicio73b.Resultado,
                       model4=model.ejercicio74b.Resultado
                       ),
                 stringsAsFactors = FALSE)
df2
...
# Apartado c
model.ejercicio71c <- gam(y~s(x1,4)+s(x2,4), data = datos)
model.ejercicio71c.Resultado <- Analisis(datos,model.ejercicio71c)
model.ejercicio71c.Resultado
