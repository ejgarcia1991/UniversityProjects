---
title: "Algoritmos extras para preprocesamiento"
author: "EMAD"
date: "28/3/2020"
output: pdf_document
---
...
Código Preprocesamiento Extra Estructurado
NOTA: No ejecutar. Son instrucciones de preprocesamiento a colocar dentro de las funciones ProcesarDatosOVO y ProcesarDatosOVA. En dichas funciones se indica el lugar donde colocar el código. Basta con copiar y pegar el código expuesto a continuación para usar dicho preprocesamiento como parte del flujo de trabajo.
```{r}
#set.seed(seed)
...
Código Preprocesamiento Extra No Estructurado
NOTA: No ejecutar. Son instrucciones de preprocesamiento a colocar dentro de las funciones ProcesarDatosOVO y ProcesarDatosOVA. En dichas funciones se indica el lugar donde colocar el código. Este código contiene las funciones que funcionan en el dataset con sus parámetros base, pero no el código estructurado necesario para usarlo.
```{r}
